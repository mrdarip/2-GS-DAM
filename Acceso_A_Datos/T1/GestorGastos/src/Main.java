...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("2. Ver todos los gastos");System.out.println("3. Calcular total de gastos");
    ...
    private static void verGastos() {try (BufferedReader reader = new BufferedReader(new
    ...
    private static void verGastosPorCategoria(Scanner scanner) {
        ...
        try (BufferedReader reader = new BufferedReader(new
            ...
            if (!encontrado) {System.out.println("No se encontraron gastos en esta categoría.");
            }
        } catch (IOException e) {
